        ...
        setContent {
            Tarjeta_PresentacionTheme {
                ...
                Surface(
                    ...
                    PresentationCard(name = stringResource(R.string.jose_jara), cargo= stringResource(
                        R.string.practicante
                    ),
                        number = stringResource(R.string._51_999999999), social = stringResource(R.string.josejara), email = stringResource(
                            R.string.josejara_gmail_com
                        )
                    )
                }
...
fun PresentationCardPreview() {
    Tarjeta_PresentacionTheme {
        PresentationCard(name = "Jose Jara", cargo="Practicante",
            number = "+51 999999999", social = "@JoseJara", email = "JoseJara@gmail.com")
    }
}